...
const FacebookIcon = () => (
  <svg x="0px" y="0px" width="266.893px" height="266.895px" viewBox="0 0 266.893 266.895"
    ...
    return (
      <div>
        ...
        <Card className={styles.loginForm}>
            ...
            <Button label="SIGN IN WITH FACEBOOK" raised primary/>

          <h3 style={{textAlign: 'center'}}className={styles.loginHeader}>or</h3>
          <LoginForm />
        </Card>
        <Footer />
      </div>
